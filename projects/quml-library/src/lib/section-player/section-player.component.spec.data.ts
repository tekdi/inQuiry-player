...
export const rearrangedOptions = {
  "left": [
      {
          "label": "<p>Red</p>",
          "value": 0
...
export const mockSectionMTFQuestions = [{
  "mimeType": "application/vnd.sunbird.question",
  ...
  "templateId": "mtf-vertical", // mtf-vertical // mtf-horizontal
  "complexityLevel": [],
  "maxScore": 1,
  "name": "MTF Colour",
  "qumlVersion": 1.1,
  ...
  "identifier": "do_11395276677466543210",
  "interactionTypes": [
      "match"
  ],
  "interactions": {
  ...
  "body": "<div class='question-body' tabindex='-1'><div class='mtf-title' tabindex='0'><p>Match the following colour with the fruits</p></div><div data-match-interaction='response1' class='mtf-vertical'></div></div>",
  ...
  "solutions": {
      "81938f25-62b2-458d-8e23-dc0223a6c3x7": "<p>Apple-Red</p><p>Yellow-Banana</p><p>Green-Grapes</p><p>Orange-Orange</p>"
  },
